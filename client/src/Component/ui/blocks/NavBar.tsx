import { ComponentType, Dispatch, LazyExoticComponent,
memo, SetStateAction, Suspense, lazy, useContext } from "react"
...
ComponentType<chatProps>> = lazy(()=>import("../../views/nav/pages/NavChats.js"));
const NavSett:LazyExoticComponent<
ComponentType<SettProps>> = lazy(()=>import("../../views/nav/pages/NavSett.js"));
